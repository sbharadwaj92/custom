...
public OnPluginStart()
{
	...
	g_hGoldKnifeCrash = CreateConVar("sm_knifeupgrade_goldknife_crash", "0", "Set to 1 to fix crash crashes with the GoldenKnife **if you have them.**", FCVAR_NONE, true, 0.0, true, 1.0);
